...
----------------------------------*/
    ...
    <div class="col-md-9 contentindex" id="panel_evento2">
        <div class="container contenedoreventos">
            <div class="panel-body scrollbar-black " runat="server">
                <div class="container-fluid">
                    ...
                    <div class="container-fluid nopadding nomargin text-right">
                        ...
                        <div class="col-md-8 nopadding nomargin" id="menuins" style="display: inline-block;">
                            <%--<a id="InformacionGeneralEvento" class="btn btn-navins insup activated">
                                   <img id="Image1" src="/Images/Icons/Info-40.png" " />
                                   Información general
                               </a>
                                <a id="AgendaActividadEvento" class="btn btn-navins insup">
                                   <img id="Image2" src="/Images/Icons/Info-40.png" " />
                                   Agenda/Actividad
                               </a>
                                <a id="InformacionAdicionalEvento" class="btn btn-navins insup">
                                   <img id="Image3" src="/Images/Icons/Info-40.png" " />
                                   Información adicional
                               </a>--%>


                            <%--<asp:LinkButton ID="DatosPersonalesEvento" runat="server" CssClass="btn btn-warning insup">
                                    <asp:Image ID="btnAgendaActividad1" runat="server" ImageUrl="/Images/Icons/Info-40.png" BackColor="Transparent" />
                                    <asp:Label ID="Label5" runat="server" Text="Información general"></asp:Label>
                                </asp:LinkButton>--%>
                            <%--<asp:LinkButton ID="btnAgendaActividad" runat="server" CssClass="btn btn-navins insup">
                                ...
                                <asp:LinkButton ID="btnInformacionAdd" runat="server" CssClass="btn btn-navins insup">
                                                                ...
                                                                <asp:Repeater ID="ChildRepeater" runat="server">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr class="colorline">
                                                                            ...
                                                                            <th style="width: 12%">
                                                                                <asp:CheckBox ID="CheckBox1" runat="server" Checked=<%#Eval("ConfirmadoParticipante") %> />
                                            ...
                                            <div class="row onlypadding-25 scrollbar-black" style="margin-right: 0; margin-left: 0; overflow-y: scroll; height: 27em; text-align: left; background-color: #F7F7F7">
                                               ...
                                               <%-- <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                ...
                                                <div class="col-sm-9" style="text-align: left; background-color: #F7F7F7">
                                                    ...
                                                    <%--<asp:LinkButton ID="btnSubirFotos" runat="server" Text="Subir Foto" BackColor="#0A445B" class="btn btn-primary" OnClick="btnUpload_Click" ></asp:LinkButton><br />--%>
                                               ...
                                               <%--     </ContentTemplate>
                                                ...
                                                <div class="col-sm-6" style="text-align: left; background-color: #F7F7F7">
                                                    ...
                                                    <asp:TextBox Visible="false" ID="txtHospedajeNombre" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                                                    ...
                                                    <form autocomplete="off" action="/action_page.php">
                                                        ...
                                                        <input visible="false" id="txtHospedajeNombre1" cssclass="form-control" style="border: solid 1px #ced4da; border-radius: 0.25rem; color: #495057;" runat="server" type="text" name="myCountry" placeholder="">
                                                    </form>
                                             ...
                                             <%--       <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                           <p id="Hasta" runat="server" class="big_02 onlymargintop-10">Hasta</p>
                                                            <%--<asp:TextBox ID="txtHosspedajeLlegadaChek" CssClass="form-control" runat="server" Width="100%" />--%>
    ...
    <script>
        ...
        {
            //alert('HOLI CHININ');
            var Long = $('#ContentPlaceHolder1_txtLong').val();
            var Alti = $('#ContentPlaceHolder1_txtAlti').val();
            //alert(Long + '   ' + Alti);
            MapaFreeStreet(Long, Alti);
        }
    </script>
