...
<head runat="server">
 ...
 .titulo {
        ...
        /*antonio*/
        .activate, .activate:visited , .activate:active{
...
.inactivate, .inactivate:visited , .inactivate:active{
...
<script type="text/javascript"> 
    ...
    function CerrarCapcha() {
         $("#ModalCaptcha").CTools.Modal.dismiss();       
    };
</script>
<body>
    ...
    <form class="form" runat="server" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
        <div class="navbar navbar-expand-lg fixed-top text-center" style="height: 80px; background-color: #0A435E;">
            ...
            <div style="background:#0A435E;">

<a href="Login.aspx?codIdioma=SPA" id="IdiomaES" class="activate">ES</a>
| 

<a href="Login.aspx?codIdioma=ENG" id="IdiomaEN" class="inactivate">EN</a>

</div>
            <%--<div class="col-md-2">
                <p class="idioma01">
                    <a href="Login.aspx?codIdioma=ENG">
                        <img class="imagen_i idioma" alt="Ingles" src="Images/ingles-off.png" id="idiomaEng" onmouseout="Interruptor()"/>
                    </a> | <a href="Login.aspx?codIdioma=SPA">
                            <img alt="Español" class="imagen_e idioma" src="Images/español.png" id="idiomaSpa" onmouseout="Interruptor()" /></a>
                </p>
            </div>--%>
                                ...
                                <div class="card rounded-0 transparente">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control form-control-lg rounded-0 inputline" onfocus="this.placeholder = ''" onblur="this.placeholder = 'CORREO ELECTRÓNICO'" placeholder="CORREO ELECTRÓNICO" required="" value="jaranar@tgestiona.com.pe" AutoPostBack ="false"></asp:TextBox>
...
//   }
            $(function () {
                var Idioma = '<%= Session["codIdioma"].ToString()%>' ;
                alert(Idioma);
                if (Idioma == "SPA") {
                    $('#IdiomaES').removeClass("inactivate");
                    $('#IdiomaES').addClass("activate");
                     $('#IdiomaEN').removeClass("activate");
                    $('#IdiomaEN').addClass("inactivate");
                }
                else {
                     $('#IdiomaES').removeClass("activate");
                    $('#IdiomaES').addClass("inactivate");
                     $('#IdiomaEN').removeClass("inactivate");
                    $('#IdiomaEN').addClass("activate");
                }
            });
</script>
</body>
