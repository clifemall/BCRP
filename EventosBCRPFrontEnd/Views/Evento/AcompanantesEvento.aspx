<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcompanantesEvento.aspx.cs" Inherits="EventosBCRPFrontEnd.Views.Evento.AcompanantesEvento" %>
...
<body>
    <form id="formAcompanante" runat="server"  >
        <asp:ScriptManager runat="server" ID="ScriptManagerAcompanante"   EnablePartialRendering="true"/>
        <asp:UpdatePanel ID="UpdatePanelAcompanante" runat="server" updatemode="Conditional">
            <%--<triggers>
