                        ...
                        <table class="w-100">
                            <tr>
                                ...
                                <td class="text-left" style="height: 28px">
                                    <asp:TextBox ID="txtContraAnte" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-left">
                                    <asp:TextBox ID="txtContraNuev1" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right">Repita su contraseñanueva:</td>
                                <td style="width: 35px">&nbsp;</td>
                                <td class="text-left">
                                    <asp:TextBox ID="txtContraNuev2" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </p>
